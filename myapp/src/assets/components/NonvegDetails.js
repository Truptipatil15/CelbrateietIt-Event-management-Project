...
import '../assets/style/NonvegDetails.css';
import img1 from '../images/Home/nveg1.jpg';
      ...
      <Row>
        <Col md={6}>
          <Card>
            ...
            />
            <Card.Body>
              <Card.Title>Nonveg Thali</Card.Title>
              <Card.Text>
              ...
              <Card.Text>
                <strong>Items:</strong>  <span>CHicken,roti,curry</span>
              </Card.Text>
