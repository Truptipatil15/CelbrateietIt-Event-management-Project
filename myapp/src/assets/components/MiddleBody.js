...
// import weddingImg from '../images/Home/img1.jpg';
// import engagementImg from '../images/Home/img4.jpg';
// import birthdayImg from '../images/Home/img3.jpg';
// import photographyImg from '../images/Home/img4.jpg';
// import cateringImg from '../images/Home/img5.jpg';

// // Import carousel images
// import carousel1 from '../images/Home/img1.jpg';
// import carousel2 from '../images/Home/img4.jpg';
// import carousel3 from '../images/Home/img3.jpg';

// function MiddleBody() {
//   const services = [
//     { title: 'Wedding', image: weddingImg, link: '#wedding' },
//     { title: 'Engagement', image: engagementImg, link: '#engagement' },
//     { title: 'Birthday', image: birthdayImg, link: '#birthday' },
//     { title: 'Photography', image: photographyImg, link: '#photography' },
//     { title: 'Catering', image: cateringImg, link: '#catering' },
//   ];
...
//  carousel images
import carousel1 from '../images/Home/hom1.jpg';
import carousel2 from '../images/Home/hom2.jpg';
import carousel3 from '../images/Home/wed2.jpg';
  ...
  return (
    <div className="middle-body">
     ...
     <h2>OUR SERVICES</h2>
      ...
      <Container>
        <h2>EXPERIENCE WITH CELEBRATE IT</h2>
      <Carousel>
        {slides.map((slide) => (
          <Carousel.Item key={slide.id}>
            <Row className="d-flex align-items-center" style={{ height: "400px" }}>
              ...
              {/* Right Side: Text */}
              <Col md={6} className="d-flex flex-column justify-content-center p-4" style={{ width:"650px",height:"500px",backgroundColor: "#f8e0d4" }}>
                <h2 >{slide.title}</h2>
